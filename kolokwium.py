...
# interpretacja najlepszego classifiera - Najlepszym z klasifikatorów okazał się RandomForestClassifier() którego accuracy(dokładność)
# wyniosła 0.76, czyli zaklasyfikował on poprawnie (zgodnie z klasą: negativ, neutral, positiv) 76% przypadków poddanych predykcji.
